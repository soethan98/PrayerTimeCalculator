...
public class PrayTime {
    ...
    // ------------------------------------------------------------
    // Calculation Methods
    public static final int JAFARI = 1; // Ithna Ashari
    public static final int KARACHI = 2; // University of Islamic Sciences, KARACHI
    public static final int ISNA = 3; // Islamic Society of North America (ISNA)
    public static final int MWL = 4; // Muslim World League (MWL)
    public static final int MAKKAH = 5; // Umm al-Qura, MAKKAH
    public static final int EGYPT = 6; // Egyptian General Authority of Survey
